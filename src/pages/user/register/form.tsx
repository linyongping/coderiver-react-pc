        ...
        <form onSubmit={this.handleSubmit} className={classes.form}>
          ...
          <FormControl className={classes.formControl}>
            <Input
              ...
              onChange={this.inputChange}
              endAdornment={
                <Button onClick={this.sendCode} className={classes.button}>{`${
                  sendCode ? '重新' : ''
                }获取验证码`}</Button>
              }
            />
            ...
            <Input
              ...
              endAdornment={
                <InputAdornment position="end">
                  <IconButton onClick={this.handleClickShowPassword.bind(this, 'showPassword')}>
          ...
          <FormControl
            className={`${classes.formSelectControl} ${classes.formRighttSelectControl}`}
          >
